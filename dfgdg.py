...
cities = {
    'москва': ['937455/6912475aa068bb3e045a', '1540737/3876fc19d1b3f91cfb89'],
    'нью-йорк': ['1030494/e43990ed4e056e35f15e', '213044/bfb57415e75ee170677e'],
    'париж': ["937455/dccd4c97138ef2e8eb3a", '937455/dccd4c97138ef2e8eb3a']
}
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'да' in req['request']['nlu']['tokens']:
                ...
                res['response']['text'] = 'фаааааааааааааааааааааааа!'
                res['end_session'] = True
            else:
        ...
        elif req["request"]['original_utteranse'].lower()=='помоги':
            res["request"]["text"] = 'fffffffa'
        else:
            play_game(res, req)
